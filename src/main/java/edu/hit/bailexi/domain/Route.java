...
public class Route implements Serializable {
     ...
     * @param junzi
     */
    public Route(int rid, String rname, double price, String routeIntroduce, String rflag, String rdate, String isThemeTour, int count, int cid, String rimage, int sid, String sourceId,String junzi) {
        this.rid = rid;
        this.rname = rname;
        this.price = price;
    ...
    public String getJunzi() {
        return junzi;
    }

    public void setJunzi(String junzi) {
        this.junzi = junzi;
    }
